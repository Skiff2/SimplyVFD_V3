...
//	{
//	if (ssd1306_I2C_IsDeviceConnected(SSD1306_I2C, i)) {
//		/* Return false */
//		return 0;
//	}
//}
	...
	SSD1306_WRITECOMMAND(0x3F); //128x64
	//SSD1306_WRITECOMMAND(0x1F);//128x32
	...
	SSD1306_WRITECOMMAND(0x12); //128*64
	//SSD1306_WRITECOMMAND(0x02);//128x32
